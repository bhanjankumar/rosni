...
g.Vc(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Bb(a)},Vpa=function(a,b,c){c=void 0===c?null:c;
var d=g.Ad("SCRIPT");d.id=a;d.onload=function(){b&&(0,window.setTimeout)(b,0)};
d.onreadystatechange=function(){switch(d.readyState){case "loaded":case "complete":d.onload()}};
c&&d.setAttribute("nonce",c);g.Xc(d,g.Td("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));a=window.document.getElementsByTagName("head")[0]||window.document.body;a.insertBefore(d,a.firstChild);return d},Wpa=function(a){a=void 0===a?null:a;
...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;M4("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",O4,c)}},$pa=function(){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
a&&(R4(),a({command:"cast.sender.init"}))},aqa=function(){R4();
var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);N4(["//www.gstatic.com/eureka/clank/"+(a?(0,window.parseInt)(a[1],10):0)+P4,"//www.gstatic.com/eureka/clank"+P4])},S4=function(a,b,c){g.G.call(this);
...
a.Tc&&(c=null);var d=(0,g.z)(a.VM,a);c||(c=new g.wm("//www.google.com/images/cleardot.gif"),Z3(c));l5(c.toString(),1E4,d)}else $4(2);L5(a,b)},L5=function(a,b){a.g=0;
